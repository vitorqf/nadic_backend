...
urlpatterns = [
    ...
    path("customers/<int:customer_id>/delete", delete_customer_by_id, name="delete_customer_by_id"),
    path("customers/create/", create_customer, name="create_customer"),
    path("customers/<int:customer_id>/edit", edit_customer_by_id, name="edit_customer_by_id"),
]
